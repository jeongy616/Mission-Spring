...
<div style="text-align: center;">
	<div style="display:inline-block;width:800px;">
		<div >
			<form action="/searchFile/1" method="post" name="searchForm">
				<select name="type">
		...
		<br>
		<table style="border:1px solid gray;" id="main">
			<colgroup>
				<col width="3%">
				<col width="10%">
				<col width="15%">
		...
		<c:forEach items="${fileList}" var="list" varStatus="status">
			<tr>
				<td><input type="checkbox"  id="${list.customerNo}" name="${list.customerNo}" value="${list.customerNo}"></td>
				<td>${list.RNUM}</td>
				...
				<td class="tLeft">
				<a href="#" 
				onclick="window.open('/upload/${list.SAVEFILE_NAME}','${list.NAME}님의 서류',)">${list.ORGINFILE_NAME}</a></td>
				<td></td>
			</tr>
		</c:forEach>
		</table>
	...
	<table style="border:0px solid black;width:100%;">
		<tr>
			...
			<c:choose>
				...
				<c:otherwise>
					<a href="/manageFile/${page.beginPage - 1}">
						<img alt="이전" src="/resources/images/btn_pre.gif" align="middle">
					</a>
				</c:otherwise>
			</c:choose>
			...
			<c:choose>
				...
				<c:otherwise>
					<a href="/manageFile/${page.endPage + 1}">
						<img alt="다음" src="/resources/images/btn_next.gif" align="middle">
					</a>
				</c:otherwise>
			</c:choose>
			...
			<c:choose>
				...
				<c:otherwise>
					<a href="/manageFile/${page.lastPage}">
						<img alt="마지막" src="/resources/images/btn_last.gif" align="middle">
					</a>
				</c:otherwise>
			</c:choose>
