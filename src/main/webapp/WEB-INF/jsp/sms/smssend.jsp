<%@ page language="java" contentType="text/html; charset=UTF-8"
   pageEncoding="UTF-8"%>    
    ...
    if(action.equals("go")) {
        ...
        String user_id = base64Encode("dlwlgml8050"); // SMS아이디
        String secure = base64Encode("691e9e47dd3d95fc857d47a90c8fce14 ");//인증키
        String msg = base64Encode(nullcheck("하나은행입니다. 인증번호는" + (String)request.getAttribute("verification") +"입니다.", ""));
        String rphone = base64Encode(nullcheck((String)request.getAttribute("phoneNum"), ""));
        String sphone1 = base64Encode(nullcheck("010", ""));
        String sphone2 = base64Encode(nullcheck("2000", ""));
        String sphone3 = base64Encode(nullcheck("5165", ""));
